<div>
    ...
    <div x-data="{ open: false }" @open-modal.window="open = true" x-show="open"
        ...
        <div class="w-full max-w-md p-6 bg-white rounded shadow-lg" @click.away="open = false">
            <h2 class="mb-4 text-xl">Create Category</h2>
            <form wire:submit.prevent="createCategory" class="flex flex-col space-y-2">
                <input wire:model="name" type="text" placeholder="New Category" class="p-2 border rounded" />
