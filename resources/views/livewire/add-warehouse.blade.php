<div>
    ...
    <div x-data="{ open: false }" @open-modal.window="open = true" x-show="open"
        ...
        <div class="w-full max-w-md p-6 bg-white rounded shadow-lg" @click.away="open = false">
            <h2 class="mb-4 text-xl">Crear Warehouse</h2>
            <form wire:submit.prevent="createWarehouse" class="flex flex-col space-y-2">
                <input wire:model="name" type="text" placeholder="Nuevo warehouse" class="p-2 border rounded" />
